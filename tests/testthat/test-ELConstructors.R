test_that("Constructor works (SummarizedExperiment)", {
  ...
  #empty object
  # expect_true(validObject(MultipleExperiment())) #exported
  ...
  expect_true(validObject(MultipleExperiment(se_empty_list)))
  names(se_empty_list) = LETTERS[1:2]
  expect_true(validObject(MultipleExperiment(se_empty_list)))

  #mixed objects
  expect_error(MultipleExperiment(list(SummarizedExperiment(), SingleCellExperiment())))

  #with annotations
  edata = data.frame('ID' = 1:3, row.names = letters[1:3])
  expect_error(MultipleExperiment(se_empty_list, experimentData = edata))
  ...
  rownames(edata) = NULL
  expect_error(MultipleExperiment(se_empty_list, experimentData = edata))
  expect_true(validObject(MultipleExperiment(se_empty_list, experimentData = edata, check.names = FALSE)))

  rownames(edata) = LETTERS[1:2]
  expect_true(validObject(MultipleExperiment(se_empty_list, experimentData = edata)))
  ...
  expect_true(validObject(MultipleExperiment(se_list)))
...
test_that("Constructor works (SingleCellExperiment)", {
  ...
  expect_true(validObject(MultipleExperiment(sce_empty_list)))
  ...
  #with annotations
  edata = data.frame('ID' = 1:3, row.names = letters[1:3])
  expect_error(MultipleExperiment(sce_empty_list, experimentData = edata))
  ...
  rownames(edata) = NULL
  expect_error(MultipleExperiment(sce_empty_list, experimentData = edata))
  expect_true(validObject(MultipleExperiment(sce_empty_list, experimentData = edata, check.names = FALSE)))

  rownames(edata) = LETTERS[1:2]
  expect_true(validObject(MultipleExperiment(sce_empty_list, experimentData = edata)))
  ...
  expect_true(validObject(MultipleExperiment(sce_list)))
...
test_that("Constructor works (SpatialExperiment)", {
  ...
  expect_true(validObject(MultipleExperiment(spe_empty_list)))
  names(spe_empty_list) = LETTERS[1:2]
  expect_true(validObject(MultipleExperiment(spe_empty_list)))

  #mixed objects
  expect_error(MultipleExperiment(list(SpatialExperiment(), SingleCellExperiment())))

  #with annotations
  edata = data.frame('ID' = 1:3, row.names = letters[1:3])
  expect_error(MultipleExperiment(spe_empty_list, experimentData = edata))
  ...
  rownames(edata) = NULL
  expect_error(MultipleExperiment(spe_empty_list, experimentData = edata))
  expect_true(validObject(MultipleExperiment(spe_empty_list, experimentData = edata, check.names = FALSE)))

  rownames(edata) = LETTERS[1:2]
  expect_true(validObject(MultipleExperiment(spe_empty_list, experimentData = edata)))
  ...
  expect_true(validObject(MultipleExperiment(spe_list)))
